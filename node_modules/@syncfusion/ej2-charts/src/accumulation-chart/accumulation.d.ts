...
import { MarginModel, BorderModel, CenterLabelModel, TooltipSettingsModel, IndexesModel, AccessibilityModel, TitleStyleSettingsModel, RadialGradientModel, LinearGradientModel } from '../common/model/base-model';
...
export declare class AccumulationChart extends Component<HTMLElement> implements INotifyPropertyChanged {
     ...
     * @private
     */
    createLinearGradient(series: AccumulationSeries, gradient: LinearGradientModel, point?: AccPoints, pointIndex?: number): string;
    /**
     ...
     * @private
     */
    createPointLinearGradient(series: AccumulationSeries, point: AccPoints, pointIndex: number, gradient?: LinearGradientModel): string;
    /**
     ...
     * @private
     */
    createPointRadialGradient(series: AccumulationSeries, point: AccPoints, pointIndex: number, gradient: RadialGradientModel): string;
    /**
     * Applies gradient fills to the accumulation chart series and its individual points.
     *
     * @returns {void}
     */
    private applyGradientsToSeries;
    /**
