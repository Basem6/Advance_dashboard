...
class Query {
     ...
     */
    sortByForeignKey(fieldName, comparer, isFromGroup, direction, foreignKeyValue) {
    ...
    processQuery(dm, query, hierarchyFilters) {
        ...
        for (let i = 0; i < queries.sorts.length; i++) {
            ...
            if (!isNullOrUndefined(queries.sorts[i].e.foreignKeyValue)) {
                request.sorts.push(DataUtil.callAdaptorFunction(this, 'onEachSort', { name: temp, comparer: queries.sorts[i].e.comparer,
        ...
        if (!isNullOrUndefined(this.adaptor[dofetchRequest])) {
            ...
            promise.then((response) => {
                ...
                fetch.onSuccess = (data, request) => {
                    ...
                    this.afterReponseRequest(data).then((responseData) => {
                        deff.resolve(this.adaptor.processResponse(responseData, this, null, request.fetchRequest, request, changes, args));
                    }).catch((e) => this.dataManagerFailure(e, deff, {}));
                };
                fetch.onFailure = (e) => {
                    deff.reject([{ error: e }]);
                };
